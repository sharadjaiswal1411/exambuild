...
`,M=({title:d,description:h,as:f="span",togglePosition:x="right",action:P,...D})=>{const{onToggle:O,toggle:R,expanded:C,id:B,size:y,variant:$,disabled:b}=(0,v.A)(),K=`accordion-content-${B}`,L=`accordion-label-${B}`,j=`accordion-desc-${B}`,A=y==="M"?6:4,I=y==="M"?A:A-2,U=u({expanded:C,disabled:b,variant:$}),W={as:f,fontWeight:y==="S"?"bold":void 0,id:L,textColor:C?"primary600":"neutral700",ellipsis:!0,variant:y==="M"?"delta":void 0},T=C?"primary600":"neutral600",F=C?"primary200":"neutral200",S=y==="M"?`${32/16}rem`:`${24/16}rem`,Z=()=>{b||(R&&!O?(p.warn('Deprecation warning: Usage of "toggle" prop in Accordion component is deprecated. This is discouraged and will be removed in the next major release. Please use "onToggle" instead'),R()):O&&O())},z=(0,t.jsx)(o.k,{justifyContent:"center",borderRadius:"50%",height:S,width:S,transform:C?"rotate(180deg)":void 0,"data-strapi-dropdown":!0,"aria-hidden":!0,as:"span",background:F,cursor:b?"not-allowed":"pointer",onClick:Z,shrink:0,children:(0,t.jsx)(r.J,{as:a.CarretDown,width:y==="M"?`${11/16}rem`:`${8/16}rem`,color:C?"primary600":"neutral600"})});return(0,t.jsx)(_,{paddingBottom:I,paddingLeft:A,paddingRight:A,paddingTop:I,background:U,expanded:C,size:y,justifyContent:"space-between",cursor:b?"not-allowed":"",children:(0,t.jsxs)(i.K,{horizontal:!0,spacing:3,flex:1,maxWidth:"100%",children:[x==="left"&&z,(0,t.jsx)(g,{onClick:Z,"aria-disabled":b,"aria-expanded":C,"aria-controls":K,"aria-labelledby":L,"data-strapi-accordion-toggle":!0,expanded:C,type:"button",flex:1,minWidth:0,...D,children:(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(m.y,{...W,children:d}),h&&(0,t.jsx)(s.Z,{as:"p",id:j,textColor:T,children:h})]})}),x==="right"&&(0,t.jsxs)(i.K,{horizontal:!0,spacing:3,children:[z,P]}),x==="left"&&P]})})}},2407:(E,c,e)=>{"use strict";e.d(c,{$:()=>m,O:()=>v});var t=e(85893),a=e(27821),n=e(41363),l=e(75515),s=e(41580),o=e(11047),i=e(63237);const r=(0,a.default)(o.k)`
  svg {
    height: ${10/16}rem;
    width: ${10/16}rem;
    path {
...
`,r=({startActions:m,endActions:v})=>m||v?t.createElement(l.x,{paddingLeft:10,paddingRight:10},t.createElement(l.x,{paddingBottom:4},t.createElement(s.k,{justifyContent:"space-between",alignItems:"flex-start"},m&&t.createElement(o,{wrap:"wrap"},m),v&&t.createElement(i,{pullRight:!0},v)))):null;r.defaultProps={endActions:void 0,startActions:void 0},r.propTypes={endActions:a.node,startActions:a.node}},53192:(E,c,e)=>{"use strict";e.d(c,{m:()=>i});var t=e(67294),a=e(27821),n=e(45697),l=e(11276);const s=`${232/16}rem`,o=(0,a.default)(l.r)`
  ...
  z-index: 1;
`,i=({ariaLabel:r,...m})=>t.createElement(o,{"aria-label":r,as:"nav",...m});i.propTypes={ariaLabel:n.string.isRequired}},38702:(E,c,e)=>{"use strict";e.d(c,{p:()=>d});var t=e(67294),a=e(45697),n=e(27821),l=e(41363),s=e(11047),o=e(75515),i=e(12028),r=e(41580),m=e(70004),v=e(49123),u=e(8509),p=e(41762);const g=h=>{const f=(0,t.useRef)();return(0,t.useEffect)(()=>{f.current=h}),f.current};var _=e(7801);const M=(0,n.default)(m.i)`
  width: ${24/16}rem;
  background-color: ${({theme:h})=>h.colors.neutral200};
`,d=({as:h,label:f,searchLabel:x,searchable:P,onChange:D,value:O,onClear:R,onSubmit:C,id:B})=>{const[y,$]=(0,t.useState)(!1),b=g(y),K=(0,p.M)("subnav-searchbar-clear",B),L=(0,t.useRef)(),j=(0,t.useRef)();(0,t.useEffect)(()=>{y&&L.current&&L.current.focus(),b&&!y&&j.current&&j.current.focus()},[y,b]);const A=()=>{$(T=>!T)},I=T=>{R(T),L.current.focus()},U=T=>{T.relatedTarget?.id!==K&&$(!1)},W=T=>{T.key===_.y.ESCAPE&&$(!1)};return y?t.createElement(r.x,{paddingLeft:4,paddingTop:5,paddingBottom:2,paddingRight:4},t.createElement(u.U,null,t.createElement(v.w,{name:"searchbar",value:O,onChange:D,placeholder:"e.g: strapi-plugin-abcd",onKeyDown:W,ref:L,onBlur:U,onClear:I,onSubmit:C,clearLabel:"Clear",size:"S"},x)),t.createElement(r.x,{paddingLeft:2,paddingTop:4},t.createElement(M,null))):t.createElement(r.x,{paddingLeft:6,paddingTop:6,paddingBottom:2,paddingRight:4},t.createElement(s.k,{justifyContent:"space-between",alignItems:"flex-start"},t.createElement(o.Z,{variant:"beta",as:h},f),P&&t.createElement(i.h,{ref:j,onClick:A,label:x,icon:t.createElement(l.Search,null)})),t.createElement(r.x,{paddingTop:4},t.createElement(M,null)))};d.defaultProps={as:"h2",searchable:!1,onChange(){},onClear(){},onSubmit(){},value:"",searchLabel:"",id:void 0},d.propTypes={as:a.string,id:a.string,label:a.string.isRequired,onChange:a.func,onClear:a.func,onSubmit:a.func,searchLabel:a.string,searchable:a.bool,value:a.string}},52305:(E,c,e)=>{"use strict";e.d(c,{E:()=>p});var t=e(67294),a=e(45697),n=e(27821),l=e(41363),s=e(41580),o=e(75515),i=e(11047),r=e(63507);const m=(0,n.default)(s.x)`
  display: flex;
  align-items: center;
...
`,p=t.forwardRef(({children:g,icon:_,withBullet:M,as:d,isSubSectionChild:h,...f},x)=>t.createElement(m,{as:d,icon:_,background:"neutral100",paddingLeft:h?9:7,paddingBottom:2,paddingTop:2,ref:x,...f},t.createElement(i.k,null,_?t.createElement(u,null,_):t.createElement(v,null),t.createElement(s.x,{paddingLeft:2},t.createElement(o.Z,{as:"span"},g))),M&&t.createElement(s.x,{as:i.k,paddingRight:4},t.createElement(v,{$active:!0}))));p.displayName="SubNavLink",p.defaultProps={as:r.f,icon:null,isSubSectionChild:!1,withBullet:!1},p.propTypes={as:a.elementType,children:a.node.isRequired,icon:a.element,isSubSectionChild:a.bool,withBullet:a.bool}},29489:(E,c,e)=>{"use strict";e.d(c,{D:()=>M});var t=e(67294),a=e(45697),n=e(27821),l=e(41580),s=e(30190),o=e(7681),i=e(41363),r=e(75515),m=e(11047);const v=(0,n.default)(m.k)`
  border: none;
  padding: 0;
